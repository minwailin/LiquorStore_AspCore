...
{
    public class MockDrinkRepo : IDrinkRepository
    {
        private readonly ICategoryRepository _categoryRepository = new MockCategoryRepo();
        ...
        public IEnumerable<Drink> IsPreferredDrink { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
